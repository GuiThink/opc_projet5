...
from database.get_json_from_api import Json
...
def main():
    ...
    Inserts(filtered_datas.final_ready_categories, filtered_datas.ready_stores, filtered_datas.final_ready_products)
